    ...
    return(
      <div>
        <Jumbotron>
          ...
          <p>Ojo, si aparece cualquier tipo de error a la hora de instalar las dependencias, debes borrar la carpeta llamada <strong>node_modules</strong>, y con la console debes ejecutar NPM INSTALL o NPM I,y ahí ejecutar el Back-end utilizando VS (Visual Studio) o VS Code (Visual Studio Code)</p>
